...
public class Fragment_newHouse_style3 extends NewHouseFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate ( R.layout.fragment_newhome_style3, container, false );
    ...
    @OnClick({R.id.btn_room1, R.id.btn_room2, R.id.btn_room3, R.id.btn_room4})
